...
def build_model(
    ...
    **kwargs,
    ...
    assert (not build_config.plugin_config.pp_reduce_scatter
            or architecture == "MixtralForCausalLM"
    ...
    if model_cls is None:
        assert (architecture
                in MODEL_MAP), f"Unsupported model architecture: {architecture}"
...
def main():
    ...
    ckpt_dir_or_model_config = (args.checkpoint_dir if args.checkpoint_dir
                                is not None else args.model_config)
